// 3TeamProject.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "pch.h"
#include "framework.h"
#include "3TeamProject.h"
#include "CMainGame.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY3TEAMPROJECT, szWindowClass, MAX_LOADSTRING);
   ...
   // _CrtSetBreakAlloc(238);
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY3TEAMPROJECT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY3TEAMPROJECT));
