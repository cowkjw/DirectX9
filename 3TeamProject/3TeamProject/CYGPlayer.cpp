...
void CYGPlayer::Render(HDC hDC)
{
	...
	if (m_PlayerState == PS_NOGUN) {
		ColorCircle(hDC, m_vLeftNoGunHandPos.x - 10 + iScrollX, m_vLeftNoGunHandPos.y - 10+ iScrollY, m_vLeftNoGunHandPos.x + 10+ iScrollX, m_vLeftNoGunHandPos.y + 10+ iScrollY, 252,194,114,2); // ¿Þ¼Õ
		ColorCircle(hDC, m_vRightNoGunHandPos.x - 10+ iScrollX, m_vRightNoGunHandPos.y - 10+ iScrollY, m_vRightNoGunHandPos.x + 10+ iScrollX, m_vRightNoGunHandPos.y + 10+ iScrollY, 252, 194, 114,2); // ¿À¸¥¼Õ
	}
	else {
		...
		ColorCircle(hDC, m_vLeftGunHandPos.x - 10+ iScrollX, m_vLeftGunHandPos.y - 10+ iScrollY, m_vLeftGunHandPos.x + 10+ iScrollX, m_vLeftGunHandPos.y + 10+ iScrollY, 252, 194, 114, 2); // ¿Þ¼Õ
		ColorCircle(hDC, m_vRightGunHandPos.x - 10+ iScrollX, m_vRightGunHandPos.y - 10+ iScrollY, m_vRightGunHandPos.x + 10+ iScrollX, m_vRightGunHandPos.y + 10+ iScrollY, 252, 194, 114, 2); // ¿À¸¥¼Õ
	}
